...
%}
%token IF ELSE FOR DO INT FLOAT CONTINUE WHILE BREAK CHAR DOUBLE CASE VOID
%token SWITCH DEFAULT GOTO RETURN PRINTLN
...
void yyerror(const char *s)
{
	outlog<<"Error at line no: "<<line_num<<" "<<s<<endl<<endl;
}

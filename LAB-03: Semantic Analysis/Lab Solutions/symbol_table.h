...
public:
    ...
    symbol_info* lookup_current_scope(const symbol_info* symbol) const;
...
inline symbol_info* symbol_table::lookup_current_scope(const symbol_info* symbol) const
{
    return current_scope == nullptr ? nullptr :
           current_scope->lookup_in_scope(symbol);
}
